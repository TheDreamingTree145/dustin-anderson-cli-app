...
module DustinAndersonCLIApp
  class Controller
    ...
    def call
      ...
      consensus_reminder = "\nIf you would like to see a movie consensus, enter 'movie consensus' and then the rank of the movie you would like the consensus of.\n\n"
      ...
      while input.downcase != 'exit'
        ...
        if input.downcase == 'top 10'
          ...
          puts options
        elsif input.downcase == 'movie consensus'
          DustinAndersonCLIApp::Movie.movie_consensus #
        else puts options
        end
      end
    end
